...
public class CalendarSelector {
    ...
    public CalendarSelector(Activity context, int position,int monposition,int dayposition,
                            ICalendarSelectorCallBack iCalendarSelectorCallBack) {
        this.mContext = context;
        this.mCallBack = iCalendarSelectorCallBack;
        this.mYearPosition = position;
        this.mMonthPosition = monposition;
    ...
    private void initPicker() {
        ...
        Log.i("qqqqqq", "initPicker: "+mYearPosition);
